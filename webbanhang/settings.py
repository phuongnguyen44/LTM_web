...
SECRET_KEY = 'django-insecure-xlwbzq%ik%b96*otp@81uw8+t%$x_@k_nc&=_g(=iomzzt!pnt'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'nguyentriphuong0104@gmail.com'
EMAIL_HOST_PASSWORD = 'igofedkconvhskew'
